function varargout=dmatrixbeta(L,bta)
% [DC,DR]=dmatrixbeta(L,bta)
%
% Based on the code by F J Simons.  
...
% bta      Euler angle in radians [default: pi/2] (of alpha,beta,gamma)
%
% OUTPUT:
%
...
disp(sprintf('dmatrix took %8.4f s',etime(clock,t0)))
